...
namespace Com.Rainier.Buskit3D
{
	...
	public class LabInterSystem : MonoBehaviour 
	{
        ...
        public  JObject SetRequestInfo()
        {
            ...
            jo.Add("role", labInfoParams.role);
            jo.Add("numberId", labInfoParams.numberId);
            jo.Add("name", labInfoParams.name);
            jo.Add("eid", labInfoParams.eid);
        ...
        {
           JObject jObject = _serviceSerializer.DeSerializerObject<JObject>(infoParams);
#if UNITY_WEBGL
            //调用jslib返回数据
