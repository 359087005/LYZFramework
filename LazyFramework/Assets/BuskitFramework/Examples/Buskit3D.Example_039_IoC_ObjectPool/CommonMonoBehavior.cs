...
namespace Buskit3D.Training.IoC.C
{
    ...
    public class CommonMonoBehavior : MonoBehaviour
    {
        ...
        /// </summary>
        [Inject]
        protected IEntityService utilsEntity;
        ...
        /// </summary>
        [Inject]
        protected ILoggingService utilsLogging;

        /// <summary>
        /// 场景中所有舞者
        /// </summary>
        [Inject]
        protected ObjectPool<DancerDataModel> dancers;

        /// <summary>
        /// 场景中所有灯
        /// </summary>
        [Inject]
        protected ObjectPool<LightDataModel> lights;
